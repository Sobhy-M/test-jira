...
import com.masary.integration.TEDataClientTest.TedataClientDenominationTest;
import com.masary.integration.TEDataClientTest.TedataClientPaymentTest;
import com.masary.integration.TEDataClientTest.TedataClientTestableError;
...
public class CashatMasaryClientTest extends TestCase{
	...
	public void testCashatInquiry_succesResponse_returnInquiryResponse() throws Exception {
		...
		CashatInquiryResponse cashatInquiryResponse  = cashatClient.cashatInquiry(cashatInquiryRequest, "ar","ODoxMjM0NTY3ODk=");
	...
	public void testPrepareUrl_succesResponse_returnFormattedURL() throws Exception {
		...
		String input = "http://172.16.10.193:9005/MasaryCashat/inquiry/{companyId}/{repNationalId}/{amount}";

		String expected = "http://172.16.10.193:9005/MasaryCashat/inquiry/1/12345678912345/20";
	...
	public void testCashatPayment_succesResponse_returnPaymentResponse() throws Exception {
		...
		CashatPaymentResponse cashatPaymentResponse =cashatClient.cashatPayment(cashatPaymentRequest,"ar","ODoxMjM0NTY3ODk=");
	...
	public void testCashatReprint_succesResponse_returnReprintResponse() throws Exception {
		...
		CashatPaymentResponse cashatPaymentResponse=cashatClient.cashatReprint("1532867950180","ar","ODoxMjM0NTY3ODk=", "192");
	...
	public void testPrepareReprintUrl_succesResponse_returnFormattedURL() throws Exception {
		...
		String input = "http://172.16.10.193:9005/MasaryCashat/reprint/{ledgerTrxId}";

		String expected = "http://172.16.10.193:9005/MasaryCashat/reprint/1532867950180";
