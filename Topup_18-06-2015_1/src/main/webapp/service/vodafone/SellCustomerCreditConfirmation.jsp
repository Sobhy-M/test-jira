...
<html>
    <head>
        ...
        <title><%=CONFIG.getConfirm(request.getSession())%> <%=CONFIG.getCustomerVodafoneTransfer(request.getSession())%></title>
    ...
    <BODY class="body" onload="ray.hide();">
        ...
        <fieldset style="width: 60%; direction: rtl;" align="right">  
            <legend align="right" ><font size="5"><%=CONFIG.getConfirm(request.getSession())%> <%=CONFIG.getCustomerVodafoneTransfer(request.getSession())%></font><img src="img/CashIn.ico"  width="20" height="20" > </legend> 
            <table border="1" width="100%">
                ...
                <tr>
                    ...
                    <td><%=CONFIG.getNewBalance(request.getSession())%> : <%=myFormatter.format(vodafonTransferBalance - Double.parseDouble(request.getParameter("DeductedAmount")))%></td></tr>
            </table>
            <details open="open">
                <summary></summary>
