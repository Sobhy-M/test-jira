...
<html>
    ...
    <form name="dobillinquiry" action="MisrElKheirController" method="POST" onsubmit="disableDoubleSubmission()">
        ...
        <div class="content_body"  >
            <fieldset style="width: 70%; direction: rtl;" align="right">  
                ...
                <details open="open">
                    <summary></summary>
                    برجاء التأكد من رقم الموبايل  و الذى تم ادخالهم فى الشاشة السابقة"  
