...
<html>
    <head>
        ...
        <script>
            ...
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><th colspan="2">مؤسسة مصر الخير لتنمية المجتمع</th></tr>');
                ...
                printwindow.document.write('<tr><td  style="padding-left:15px;width: 50%;"><%=new String(request.getParameter(CONFIG.PROGRAM).getBytes("ISO-8859-1"), "utf-8")%></td><td style ="text-align: right;padding-right:25px;width: 50%;" > نوع التبرع</td></tr>');
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%= request.getParameter(CONFIG.AMOUNT)%></td><td style="text-align: right;padding-right:25px;width: 50%;">مبلغ التبرع </td> </tr>');
    ...
    <th><H3 style="color: red; font-size: 18px"><%=CONFIG.getMisrElKherRecieptMess1(session)%><br><%=paymentRespponseDto.getTRANSACTION_ID()%><br></H3></th>
<br><br>
...
<div  >
    <table cellspacing="10" cellpadding="4" style="font-size: 20px; font-weight: 900;" > 
        ...
        <tr><th colspan="2" style="font-size: 18px;text-align:center"><%= new String(request.getParameter(CONFIG.PROGRAM).getBytes("ISO-8859-1"), "utf-8")%></th> </tr>
