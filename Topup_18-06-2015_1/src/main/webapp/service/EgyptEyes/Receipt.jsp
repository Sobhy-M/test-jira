...
<fmt:bundle basename="Bundle">
    ...
    <html>
        ...
        <body class="body" >
            ...
            <form name="doinquiry" action="EgyptEyesControllerPayment" method="POST" >
                ...
                <div> 
                    ...
                    <table cellspacing="10" style="font-size: 12px; font-weight: 900;"  > 
                            <tr><td style="width: 50% ; padding-right: 30px;text-align: right;" colspan="2 "><fmt:message key="Donations_Donateservice"/> &nbsp;<fmt:message key="DonationInstitute"/> <fmt:message key="Donation_EgyptEyesLAbel"/> </td></tr>
