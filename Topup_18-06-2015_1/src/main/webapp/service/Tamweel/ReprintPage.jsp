<%-- 
    ...
    Created on : Feb 27, 2019, 1:17:13 PM
            ...
            <script>
                ...
                function setDivPrint() {
                    ...
                    if (${tamweelPaymentRepresentation.partialPayment} !== 0) {
                        printwindow.document.write('<tr><td><fmt:message key="TamweelPartialPayment"/>: ${tamweelPaymentRepresentation.serviceAmount} </td></tr>');
                    }
                    printwindow.document.write('<tr><td><fmt:message key="TamweelPaymenttax"/>:<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${tamweelPaymentRepresentation.appliedFees}"/></td></tr>');
