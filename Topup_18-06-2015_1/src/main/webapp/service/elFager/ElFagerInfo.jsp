...
<html>
    ...
    <form name="dobillinquiry" action="ElFagerPaymentController" method="POST" onsubmit="return validateBillBayCredit(<%=BTC.isIS_FRAC_ACC()%>)">
        <input type="hidden" name="action" value="<%=CONFIG.ACTIONElFagerPayment%>" />
