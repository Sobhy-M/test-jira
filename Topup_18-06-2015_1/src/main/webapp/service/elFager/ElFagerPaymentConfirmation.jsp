...
<html>
    <head>
        ...
        <script>
            ...
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><th colspan="2">دفع فاتورة  انترنت الفجر</th></tr>');
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%= new String(request.getParameter("Customer_name").getBytes("ISO-8859-1"), "utf-8") %></td><td style = "text-align: right;padding-right:25px;width:50%;">اسم العميل </td> </tr><tr>');
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%=request.getParameter(CONFIG.PARAM_MSISDN) %></td><td style = "text-align: right;padding-right:25px;width:50%;">رقم التليفون</td> </tr><tr>');
    ...
    <body class="body">
        <div>
            ...
            <h3 style="color: red; font-size: 18px"><%=CONFIG.getElfagerADSLRecieptMess1(session)%><%=billResonse.getTRANSACTION_ID()%><br></h3>
        <div>
