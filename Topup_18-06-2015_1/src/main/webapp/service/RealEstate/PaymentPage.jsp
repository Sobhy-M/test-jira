<%-- 
    ...
    Created on : Mar 17, 2019, 11:19:18 AM
    Author     : user
--%>
            ...
            <form action="<%=CONFIG.APP_ROOT + (String) request.getSession().getAttribute(CONFIG.PARAM_ROLE) + ".jsp"%>" method="POST" >
                <div>
                    <table cellspacing="10" style="font-size: 12px; font-weight: 900;"  > 
                        <tr><td style="width: 50% ; padding-right: 30px;text-align: right;"><fmt:message key="Lable_RealEstate_trxId"/></td><td style="padding-left: 10px;"> ${paymentRepresentation.globalTrxId}</td></tr>
                        <tr><td style="width: 50% ; padding-right: 30px;text-align: right;"><fmt:message key="Lable_RealEstate_yourCommession"/></td><td style="padding-left: 10px;"> <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${paymentRepresentation.merchantCommission}" /></td></tr>
                        <tr><td style="width: 50% ; padding-right: 30px;text-align: right;"><fmt:message key="Lable_RealEstate_deductedAmount"/></td><td style="padding-left: 10px;"> <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${paymentRepresentation.transactionAmount}" /></td></tr>
