...
<%
    ...
    if (TheOperation.equals("1")) {
        ...
        ProjectName = "صدقة جارية";
    } else if (TheOperation.equals("3")) {
        ProjectName = "كفالة سرير";
    } else if (TheOperation.equals("4")) {
        ProjectName = "ادوية ومستلزمات طبية";
    }
    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><th colspan="2">مستشفى القصر العيني للحوادث و الحروق</th></tr>');
