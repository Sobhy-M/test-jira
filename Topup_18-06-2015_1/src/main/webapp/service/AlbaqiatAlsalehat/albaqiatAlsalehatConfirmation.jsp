...
<html>
    ...
    <body class="body" onload="onValueChanged();">
        ...
        <form name="ElbakyatElsalhatConfirmation" action="ElbakyatElsalhatPayController" method="POST" >
            <div class="content_body"  >
                <fieldset style="width: 70%; direction: rtl;" align="right">
                    ...
                    <table  border="1" width="100%">
                        ...
                        <tr>
                            <td>
                                <p  align="right"><%= CONFIG.getWKDonationType(session)%>:<input name="DonationType"  autocomplete="off" value="<%=request.getParameter("DonationType")%>" type="text" id="DonationType" maxlength="20" title="<%=CONFIG.getWKDonationType(session)%>" style="float: left;background-color: #EDEDED;"></p>
