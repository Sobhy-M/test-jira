...
<script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">  <%=tedataPaymentResponse.getRequestStatus()%>   </td><td style="text-align: right;padding-right:25px;width: 50%;"><%=CONFIG.getServiceState(session)%></td> </tr>');
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">  <%=tedataPaymentResponse.getPackageQuota()%>  </td><td style = "text-align: right;padding-right:25px;width:50%;"><%=CONFIG.get_Tedata(session)%></td> </tr><tr>');
