    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td><img src="./img/hospital25.jpg"  width="80" height="60"/></td><td><img src="./img/Masary.jpg"  width="80" height="60"/></td></tr>');
                printwindow.document.write('<tr><th colspan="2">شركة مصاري</th></tr>');
                printwindow.document.write('<tr><th colspan="2"><%=CONFIG.HOSPITAL_25_SERVICE %></th></tr>');
        ...
        <form action="<%=CONFIG.APP_ROOT + role + ".jsp"%>" method="POST" style="font-weight: bold">
            ...
            <table style="width: 50% ; margin-left: auto ; margin-right: auto"  >
                ...
                <tr style="display: none">
                    <td><img src="./img/hospital25.jpg "  width="100" height="60"/></td>
