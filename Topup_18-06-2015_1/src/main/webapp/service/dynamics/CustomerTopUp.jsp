        ...
        <div class="content_body"  ><br><br>
            ...
            <table>
                <tr>
                    ...
                    <th rowspan="7"><input type="submit" name="btnSubmit" tabindex="2" value="<%=CONFIG.getGo(request.getSession())%>" class="Btn"></th>
                </tr>
                <tr>
                    <th scope="col" ><%=CONFIG.getDynamicsWalletId(request.getSession())%></th>
                    <td><input id="custTopUpMobileId" type="text" name="<%=CONFIG.PARAM_DYNAMICS_ACCOUNT_ID%>" tabindex="1"></td>
                </tr>
            </table>
