...
<fmt:bundle basename="Bundle">
    ...
    <html>
        ...
        <body class="body" >
            ...
            <form name="doinquiry" action="Hospital500500ControllerPayment" method="POST" >
                ...
                <div> 
                    ...
                    <table cellspacing="10" style="font-size: 12px; font-weight: 900;"  > 
                        <tr><td style="width: 50% ; padding-right: 30px;text-align: right;" colspan="2 "><fmt:message key="Donations_Donateservice"/> &nbsp;<fmt:message key="DonationInstitute"/> <fmt:message key="Donations_Notice_MESSAGE_500500Institute"/> </td></tr>
                        <tr><td style="width: 50% ; padding-right: 30px;text-align: right;" colspan="2 "><fmt:message key="Donations_DonateToAr"/> <fmt:message key="Donations_Notice_MESSAGE_500500Institute"/> </td></tr>
