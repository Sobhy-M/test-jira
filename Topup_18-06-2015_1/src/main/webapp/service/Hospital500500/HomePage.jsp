...
<fmt:bundle basename="Bundle">
    <html>
        <head>
            ...
            <title><fmt:message key="Donation_hospital500500LAbel"/></title>
            ...
            <div class="content_body"  >
                ...
                <form name="doinquiry" action="Hospital500500ConfirmationController" method="POST" >
                    <fieldset style="width: 30%; direction: rtl;" align="right">  
                        <legend align="right" ><font size="5"><fmt:message key="Donation_hospital500500LAbel"/></font><img src="img/CashIn.ico"  width="20" height="20" > </legend>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <p align="right"><fmt:message key="Donation_amount"/>
                                        <input type="number" id="amount" name="amount"  min="5" style="float: left;" required 
                                               oninvalid="this.setCustomValidity('برجاء إدخال قيمة اكبر  من  5 جنيه')" oninput="setCustomValidity('')"/>
                                    </p>
