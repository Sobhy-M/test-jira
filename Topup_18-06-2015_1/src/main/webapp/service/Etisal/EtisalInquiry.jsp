        ...
        <form name="dobillinquiry" action="EtisalContoller" method="POST">
            ...
            <fieldset style="width: 28%; direction: rtl;" align="right">  
                <legend align="right" ><font size="3"><%= CONFIG.getCustomerBillHead(session)%>
                        &nbsp;<%= CONFIG.EtisalServiceName%></font><img src="img/CashIn.ico"  width="20" height="20" > </legend>
                <table border="1" width="100%">
                    <tr>
                        <td><p align="right"><%=CONFIG.EtisalLabel%> : <input id="custTopUpDalanceID" type="number" required name="<%=CONFIG.PARAM_MSISDN%>" tabindex="2"></p>
