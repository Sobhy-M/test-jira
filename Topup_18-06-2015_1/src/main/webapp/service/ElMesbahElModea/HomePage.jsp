        ...
        <head>
           ...
           <script>
            ...
            <div class="content_body"  >
                ...
                <form name="doinquiry" action="ElMesbahElModeaConfirmationController" method="POST" >
                    <fieldset style="width: 30%; direction: rtl;" align="right">  
                        <legend align="right" ><font size="5"><fmt:message key="ElMesbahElModeaLabel"/></font><img src="img/CashIn.ico"  width="20" height="20" > </legend>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div id="amountDiv" style="color: red; font-size: 12.5px;"></div>
                                      ...
                                      <p align="right"><fmt:message key="Donations_Governorate"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            
                                          <select name="governorateId" id="governorateId"   required>
                                            <c:forEach items="${governorates.governorateDtos}" var="role">
                                               
                                                    <option value="${role.id}">  ${role.governorateName}</option>
                                    ...
                                    <p style="color: red;">
                                        <fmt:message key="Donations_Notice"/>: <input id="notice" value="${governorates.warnStr}"
