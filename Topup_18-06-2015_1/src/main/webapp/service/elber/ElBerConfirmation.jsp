...
<html>
    ...
    <body>
        ...
        <form action="ElBerPayController" method="POST" style="font-weight: bold">
            <input type="hidden" name="action" value="<%=CONFIG.ACTION_ELBER_PAY%>" />
            <h2 align="center" ><%=CONFIG.ELBER_SERVICE%></h2>
            <table style="width: 50% ; margin-left: auto ; margin-right: auto"  >
                <tr>
                    <th colspan="2" style="text-align: center"><p><%= new  String( request.getParameter("ProjectName").getBytes("ISO-8859-1"),"UTF8") %></p></th>
                </tr>
                <tr class="secondTD">
