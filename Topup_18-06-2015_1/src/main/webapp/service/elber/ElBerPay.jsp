...
<%
   ...
   // Masary_Bill_Type BTC = MasaryManager.getInstance().getBTC(String.valueOf(session.getAttribute("SERVICE_ID").toString()));
    ...
    Double fixedAmount = ratePlan.getFixedAmount();
    Double DedducedAmount = Double.parseDouble(request.getParameter("TheDonationVal")) +fixedAmount- Commession ;
    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><th colspan="2"><%=CONFIG.ELBER_SERVICE %></th></tr>');
