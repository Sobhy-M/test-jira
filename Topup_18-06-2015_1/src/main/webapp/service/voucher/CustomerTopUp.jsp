    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function onChangeVoucherValueValidation() {
            	...
            	if(document.getElementById("custTopUpDalanceID").value==="50"||document.getElementById("custTopUpDalanceID").value==="100"){
...
//                        alert( document.getElementById("topupdemo").value);
            ...
            function checkCount() {
            	...
            	var amount=document.getElementById("custTopUpDalanceID").value;
                if (voucherNoValidate > 10 && (amount==="100" || amount==="50")) {
                    document.getElementById("custTopUpVoucherNODiv").innerHTML = 'من فضلك ادخل رقم اقل من او يساوى 10 ';
                    return false;
                } 
                else if(voucherNo>20 && (amount!=="100" || amount!=="50")){
                	  document.getElementById("custTopUpVoucherNODiv").innerHTML = 'من فضلك ادخل رقم اقل من او يساوى 20 ';
                      return false;
                }
                document.getElementById("custTopUpVoucherNODiv").innerHTML = "";
                ...
                <table style="width: 100% ; margin-left: auto ; margin-right: auto ;border: #000;border-width: 1" border="1" >
                    ...
                    <tr>
                        <td><table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <select   name="<%=CONFIG.AMOUNT%>" tabindex="1" id="custTopUpDalanceID" onchange="onChangeVoucherValueValidation();onChangeVoucherValue();onValueChanged()" >
                                ...
                                <tr>
                                    ...
                                    <% if (serviceId == 16){ %>
                                        ...
                                        <div style="visibility: visible"  id="voucherNoValidate">
                                            <input id="custTopUpVoucherNoValidate"  value="1" name="<%=CONFIG.PARAM_VOUCHERNO%>"   type="number"  disabled="disabled"   onchange="onChangeVoucherValue()">
                                    ...
                                    <%}else{ %>
                                        ...
                                        <div style="visibility: visible"  id="voucherNoValidate">
                                            <input id="custTopUpVoucherNoValidate"  value="1" name="<%=CONFIG.PARAM_VOUCHERNO%>"   type="number"  onchange="onChangeVoucherValue()">
                                          
                                          
                                        </div>
                                        
                                         <div style="visibility: visible"   id="voucherNo">
                                            <input id="custTopUpVoucherNo" value="1" name="<%=CONFIG.PARAM_VOUCHERNO%>"   type="number"  onchange="onChangeVoucherValue()"  >
                                        </div>
                              <%} %>
