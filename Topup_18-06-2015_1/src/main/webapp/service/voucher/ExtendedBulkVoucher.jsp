<%-- 
    Document   : ExtendedBulkVoucher
    Created on : Sept 19, 2015, 10:24:53 AM
    Author     : Amir Serry
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            <%} else {%>
                        document.getElementById("custTopUpVoucherNo").max = "200";
            <%}%>
                    }
            <%}%>
                }
                            ...
                            <td><table  width="100%" >
                                    ...
                                    <table id="dataTable" width="100%" >
                                        <tr>
                                            ...
                                            <td width="10%">
                                                <input style="margin-right: 37%"  id="custTopUpVoucherNo" value="1" name="<%=CONFIG.PARAM_VOUCHERNO%>"  tabindex="2" type="number" min="1"  max="200"  >
                                            </td>
                                            <td width="10%">
