    ...
    <html>
        <head>
            ...
            <div class="content_body"  >
                ...
                <form name="doinquiry" action="SonaaElkherConfirmationController" method="POST" >
                    <fieldset style="width: 30%; direction: rtl;" align="right">  
                        <legend align="right" ><font size="5"><fmt:message key="Donation_SonnaaLAbel"/></font><img src="img/CashIn.ico"  width="20" height="20" > </legend>
                        <table border="1" width="100%">
                            <tr>
                                <td colspan="2">
                                    <p align="right"><fmt:message key="Donation_mainmenuLAbel"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    

                                        <select name="donationTypeId" id="donationTypeId" style="text-align: center" required="">
                                    ...
                                    <p align="right"><fmt:message key="Donation_amount"/>
                                        <input type="number" id="amount" name="amount"  max="1000" style="float: left;" required 
                                               oninvalid="this.setCustomValidity('برجاء إدخال قيمة اقل من 1000 جنيه')" oninput="setCustomValidity('')" /> 
                                    </p>
                                    ...
                                    <p style="color: red;">
                                        <fmt:message key="Donations_Notice"/>: <input id="notice" value="${donationType.warnMessage}"
                                                 readonly style="color: black; font-size: small; width: 220px; ">
