    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td colspan="2" style="text-align: center"><img src="img/ReliefFoundation.png"  width="200" height="60"></td></tr>');
                printwindow.document.write('<tr><th colspan="2">مؤسسة الإغاثة و الطوارئ</th></tr>');
        ...
        <div>
            ...
            <table cellspacing="10" cellpadding="4" style="font-size: 20px; font-weight: 900; width: auto" > 
                ...
                <tr style="display: none">
                    <th colspan="2"><img src="./img/ReliefFoundation.png" alt="wasletKher" width="50" height="50"></th>
                </tr>
            </table>
        </form>
