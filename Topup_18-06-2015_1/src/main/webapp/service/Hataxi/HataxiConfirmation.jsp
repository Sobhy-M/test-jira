...
<%@page import="com.masary.integration.dto.HataxiInquiryResponse"%>
...
<%
    ...
    HataxiInquiryResponse validationResponse = (HataxiInquiryResponse) request.getSession().getAttribute("validationResp");
...
<html>
    ...
    <body>
        ...
        <form action="HataxiController" method="POST" style="font-weight: bold">
                ...
                <tr>
                    ...
                    <td>
                        <p>المبلغ المطلوب دفعه
                            <br>شامل ضريبة القيمه المضافه و الرسوم:</p>
                    </td>
                    <td>
                        <div>
                            <div>
