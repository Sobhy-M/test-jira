...
<html>
    ...
    <body class="body" onload="onValueChanged();" onsubmit="submit();">
        <div>
        ...
        <form name="BaitAlzakahPayment" action="BaitElzakahPaymentController" method="POST" >
                    ...
                    <table  border="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p align="right"><%=CONFIG.getDeductedAmountMaan(session)%> :<input value="<%=request.getParameter("DeductedAmount")%>" type="text" name="DeductedAmount" autocomplete="off" readonly tabindex="6" id="DeductedAmount" style="background-color: #EDEDED; float: left;"/><div></div></p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <input type="submit" name="btnSubmit" id="btnSubmit" tabindex="4"  value="<%=CONFIG.getpayment(session)%>" class="Btn" >
                                <input type="button" name="Back" id="btnBack" tabindex="3" value="<%=CONFIG.getBack(session)%>"  style="float: left" onclick="history.go(-1);">
                            </td>
                        </tr>
                    </table>
                    <details open="open">
