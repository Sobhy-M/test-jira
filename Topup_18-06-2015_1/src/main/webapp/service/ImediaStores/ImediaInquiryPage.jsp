...
<html>
    ...
    <body class="body">
        ...
        <div class="content_body">
            <form name="Imediainquiry" action="ImediaOperationInfoController" method="POST">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="OperationID" maxlength="30" title="<%=CONFIG.GetOperationIdTitle_Ar(request.getSession())%>" pattern="^[0-9]\d*(\.\d{1,9})?"  type="text" required name="OperationID" autocomplete="off" autofocus>
                        </td>
                    </tr>
                    <tr>
