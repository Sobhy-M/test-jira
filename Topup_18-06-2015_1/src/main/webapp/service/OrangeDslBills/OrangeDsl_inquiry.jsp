        ...
        <form name="dobillinquiry" action="<%=CONFIG.APP_ROOT%>Bill_Controler" method="POST" onsubmit="return validateBillphone();">
            ...
            <fieldset style="width: 28%; direction: rtl;" align="right">  
                ...
                <table border="1" width="100%">
                    <tr>
                        <td><p align="right"><%=BTC.get_BILL_LABLE(session)%> : <input id="custTopUpDalanceID" maxlength="11" pattern="^[0-9]\d*(\.\d{1,9})?"  type="text" required name="<%=CONFIG.PARAM_MSISDN%>" autocomplete="off" tabindex="2"></p>
