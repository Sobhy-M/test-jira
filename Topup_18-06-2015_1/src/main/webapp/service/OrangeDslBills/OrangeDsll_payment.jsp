...
<html>
        ...
        <script type="text/javascript">
            ...
            function check() {
                ...
                if (oJavaDetect.length === 0)
                {
                    ...
                    element.innerHTML = "<img src='https://cdn.e-masary.net/app/img/javaicon.png' />";
  ...
  <p align="right"><%=CONFIG.GetMinPaymentAmount(session)%> : 
                                    <input type="text" name="MinPaymentAmount" tabindex="1"  id="MinPaymentAmount" value="<%=request.getParameter("MinPaymentAmount")%>" readonly style="background-color: #EDEDED; float: left;">
                                </p>
