...
<html>
    <head>
        ...
        <script>
            ...
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%= request.getParameter("BILLING_ACCOUNT")%></td><td style = "text-align: right;padding-right:25px;width:50%;">رقم التليفون</td> </tr><tr>');
    ...
    <h3 style="color: red; font-size: 18px"><%=CONFIG.getOrangeDSLRecieptMess1(session)%><%=billResonse.getTRANSACTION_ID()%><br><%=CONFIG.getBillRecieptMess3(session)%><%=billResonse.getPROVIDER_TRANSACTION_ID()%></h3>
<div>
    <table cellspacing="10" style="font-size: 20px; font-weight: 900;" > 
        ...
        <tr><td style="width: 50% ; padding-right: 30px;text-align: right;">رقم التليفون </td><td style="padding-left: 10px;"><%= request.getParameter("BILLING_ACCOUNT")%></td></tr>
