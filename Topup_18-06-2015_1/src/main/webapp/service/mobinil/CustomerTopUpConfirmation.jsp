...
<html>
    ...
    <BODY class="body" onload="ray.hide();">
        ...
        <input type="hidden" name="<%=CONFIG.TOPUP_TYPE%>" value="8" />
        <input type="hidden" name="<%=CONFIG.CONFIRM%>" value="True" />
        <fieldset style="width: 70%; direction: rtl;" align="right">  

            <legend align="right" ><font size="5"><%=CONFIG.getConfirm(request.getSession()) + "  " + CONFIG.getCustomerMobinilTopUp(request.getSession())%></font><img src="https://cdn.e-masary.net/app/img/CashIn.ico"  width="20" height="20"> </legend> 
            <table border="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td><%=CONFIG.getNewBalance(request.getSession())%> : <%=myFormatter.format(mobinilBalance - Double.parseDouble(requestParameters.get("DeductedAmount")))%></td></tr>
            </table>
            <details open="open">
                <summary></summary>
