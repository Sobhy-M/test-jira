...
<%@page import="com.masary.integration.dto.GooBackValidateResponse"%>
...
<%
    ...
    GooBackValidateResponse validationResponse = (GooBackValidateResponse) request.getSession().getAttribute("validationResp");
...
<html>
    <head>
        ...
        <title><%=CONFIG.GOO_BACK_SERVICE%></title>
    ...
    <body>
        ...
        <form action="GooBackController" method="POST" style="font-weight: bold">
