...
<%@page import="com.masary.integration.dto.GooBackPayResponse"%>
...
<%
    ...
    GooBackPayResponse payResponse = (GooBackPayResponse) request.getSession().getAttribute("payResponse");
...
<html>
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td><img src="./img/goo.png"  width="100" height="60"/></td><td><img src="./img/Masary.jpg"  width="80" height="60"/></td></tr>');
                printwindow.document.write('<tr><th colspan="2">شركة مصاري</th></tr>');
                printwindow.document.write('<tr><th colspan="2"><%=CONFIG.GOO_BACK_SERVICE %></th></tr>');
    ...
    <body>
        ...
        <form action=<%=CONFIG.APP_ROOT + role + ".jsp"%> method="POST" style="font-weight: bold">
            ...
            <h2 align="center" ><%=CONFIG.GOO_BACK_SERVICE %></h2>
            <table style="width: 50% ; margin-left: auto ; margin-right: auto"  >
                ...
                <tr style="display: none">
                    <td><img src="./img/goo.png"  width="100" height="60"/></td>
