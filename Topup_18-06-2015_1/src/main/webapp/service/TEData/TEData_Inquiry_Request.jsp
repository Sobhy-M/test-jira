<%-- 
    Document   : TEData_Inquiry_Request
    Created on : Oct 2, 2017, 3:37:35 PM
    Author     : Tasneem
--%>
...
<%
    MasaryManager.logger.info("TEData_Inquiry_Request_Page");
...
<html>
    ...
    <div class="content_body"  >
        <form name="dobillinquiry" action="<%=CONFIG.APP_ROOT%>TEBills_Home" method="POST" onsubmit="return validateBillphone();">
            ...
            <fieldset style="width: 28%; direction: rtl;" align="right">  
                ...
                <table border="1" width="100%">
                    <tr>
                        <td><p align="right"><%=BTC.get_BILL_LABLE(session)%> : <input id="custTopUpDalanceID" name="BILLING_ACCOUNT" type="text" required name="<%=CONFIG.PARAM_MSISDN%>" tabindex="2"></p>
