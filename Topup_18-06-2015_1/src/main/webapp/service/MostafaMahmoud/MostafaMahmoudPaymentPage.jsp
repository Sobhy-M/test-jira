    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><th colspan="2">جمعية مسجد .مصطفى محمود</th></tr>');
                  <%if (request.getParameter(CONFIG.OPERATION_ID).equals("113")) {%>
                printwindow.document.write('<tr><th colspan="2">صك خروف العيد البلدى</th></tr>');<%}%>
                  <%if (request.getParameter(CONFIG.OPERATION_ID).equals("117")) {%>
                printwindow.document.write('<tr><th colspan="2">صك العجول البلدى</th></tr>');<%}%>
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%=request.getParameter("Amount")%> </td><td style ="text-align: right;padding-right:25px;width: 50%;" >:اجمالى المبلغ المطلوب</td></tr>');
                ...
                printwindow.document.write('<tr> <th colspan = "2" style = "text-align:center;font-size:16px; ">www.e-masary.com <p></th> </tr> </table> ');
    ...
    <body class="body">
        <div>
            ...
            <table cellspacing="10" cellpadding="4" style="font-size: 20px; font-weight: 900; width: auto" > 
                <tr>
                    <td colspan="2" style="text-align: center">جمعية مسجد د.مصطفى محمود</td> 
                </tr>
                <tr><td style="width: 50% ; padding-right: 30px;text-align: right;">مبلغ التبرع بالجنيه المصرى </td><td style="padding-left: 10px;"><%= request.getParameter("Balance_Diff")%></td></tr>
