...
<%
    MasaryManager.logger.info("noorAdsl");
...
<html>
    ...
    <div class="content_body"  >
        <form name="dobillinquiry" action="NoorDSLInquiryContoller" method="POST" onsubmit="return validateBillphone();">

            <input type="hidden" name="action" value="<%=CONFIG.ACTIONNOORADSLGETINFO%>" />
