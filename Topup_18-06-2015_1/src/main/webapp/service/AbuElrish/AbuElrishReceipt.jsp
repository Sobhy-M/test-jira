...
<%
	...
	AbuElRishResponseDTO abuelrishResponseDTO = (AbuElRishResponseDTO) request
			.getAttribute("abuelrishResponseDTO");
	Date date = new Date(abuelrishResponseDTO.getUpdateDate());
...
<script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%=new String(request.getParameter("abuelrishType").toString().getBytes("ISO-8859-1"), "utf-8")%></td><td style="text-align: right;padding-right:25px;width: 50%;">نوع  التبرع </td> </tr>');
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;"><%=abuelrishResponseDTO.getPaymentAmount()%></td><td style="text-align: right;padding-right:25px;width: 50%;"> اجمالى المبلغ المطلوب دفعه</td> </tr>');
