...
<%
	...
	String taxAmount = (String) request.getAttribute(CONFIG.PARAM_TAX_AMOUNT);
...
<BODY class="body">
	...
	<div class="content_body">
		...
		<fieldset style="width: 37%; direction: rtl;" align="right">
			...
			<legend align="right">
				<font size="5"><%=CONFIG.getTransactionReport(session)%></font><img
			...
			<table border="1" width="100%">
				...
				<tr>
					...
					%>
					<td><%=MasaryManager.getInstance()
						.getEmployee((String) session.getAttribute(CONFIG.PARAM_EMPLOYEE_ID)).getEmployeeName(session)%></td>
					<%
						}
					%>
				</tr>
				...
				<tr>
					<form action=<%=CONFIG.APP_ROOT + role + ".jsp"%> method="post"
						name="admin_form" id="saveform">
						<td colspan="2" align="center"><input type="submit"
							name="btnSubmit" tabindex="5" value="OK" class="Btn"></td>
					</form>

				</tr>
			</table>
			<details open="open"> <summary></summary> <%=CONFIG.getTRANSFER_FEES_TRANS_DETAILS(session)%>
			</details>
	</div>
