            ...
            <title><fmt:message key="messagePrint4"></fmt:message></title>
              <script>
                 function setDivPrint() {
                    ...
                    printwindow.document.write('<tr><td><fmt:message key="Lable_EtisalatGifts_TrxId"/>: ${reprintResponse.globalTrxId}</td></tr>');
                    ...
                    printwindow.document.write('<tr><td><fmt:message key="Reciept_EtisalatGifts_WalletID"/>: ${reprintResponse.accountId}</td></tr>');
                    printwindow.document.write('<tr><th  colspan = "2">________________________________________ </th></tr>');
                    printwindow.document.write('<tr><td><fmt:message key="Lable_EtisalatGifts_MobileNumber"/>: ${reprintResponse.mobileNumber}</td></tr>');
                    printwindow.document.write('<tr><td><fmt:message key="Reciept_EtisalatGifts_SerialNumber"/>: ${reprintResponse.voucherSerial}</td></tr>');
                    printwindow.document.write('<tr><td><fmt:message key="Reciept_EtisalatGifts_CouponAmount"/>:  <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value=" ${reprintResponse.voucherAmount}" />  <fmt:message key="Reciept_EtisalatGifts_CouponCodeEGP"/></td> </tr><tr>');
