...
<body class="body">
	...
	<div class="content_body">
		<form action="CashatMasaryPayment" method="POST">
						...
						<td colspan="3">
							<div align="center">
								<input type="submit" name="btnSubmit" tabindex="4"
									...
									value="<%=CashatMasaryProperties.Action_CashatMasary_EditLabel%>"
									onclick="history.go(-1);" align="center"> <input
									type="button" name="btnSubmit" tabindex="4" id="buttonSubmit"
									value="<%=CashatMasaryProperties.Action_CashatMasary_CancelLabel%>"
