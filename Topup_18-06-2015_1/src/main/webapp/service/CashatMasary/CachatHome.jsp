...
<%@page
   ...
   input[type=number]::-webkit-inner-spin-button, 
        ...
        <body class="body" onload="onload()" >
            ...
            <form id="form" action="CashatMasaryConfirmation" method="POST">
                <input type="hidden" name="cashatMasaryCompanies" id="cashatMasaryCompanies" value="${cashatMasaryCompanies}" /> 
                <input type="hidden" name="Idcompany" id="Idcompany" />
                <div class="content_body">
                    <fieldset style="width: 35%; direction: rtl;" align="right">
                        <legend align="right">
                            <font size="3"><%=CashatMasaryProperties.Param_CashatMasary_ServiceName%></font>&nbsp;<img
                        ...
                        <table border="1" width="100%">
                            ...
                            <tr>
                                <td>
                                    <p align="right">
                                        <%=CashatMasaryProperties.Param_CashatMasary_CompanyLabel%>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <input	list="companyId" id="inputList" autocomplete="off">

                            <datalist id="companyId" name="companyId">
                                <option value="0" selected disabled><%=CashatMasaryProperties.Param_CashatMasary_Select%></option>
                                <c:forEach var="menu" items="${cashatMasaryCompanies.getCompanies()}">
                                    <option id="${menu.companyID}" data-companyvalue="${menu.companyID}" value ="${menu.companyNameAr}"/>
                                </c:forEach> </datalist>
                            </p>
                            <p align="right"><%=CashatMasaryProperties.Param_CashatMasary_NationalIdLabel%>
                                &nbsp;&nbsp; 
                                <input type="text" id="nationalId" name="nationalId" required maxlength="14" >
                            <div id="nationalIdDiv" style="color: red"></div>
                            </p>
                            <p align="right"><%=CashatMasaryProperties.Param_CashatMasary_AmountLabel%>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                <input type="text" id="amount" name="amount" required maxlength="9">
                            <div id="amountDiv" style="color: red"></div>
                            </p>
                             <c:choose>
                             <c:when test="${cashatMasaryCompanies.warnSTR != ''}">
                             <p align="right" style="color: red"><%=CashatMasaryProperties.Param_CashatMasary_NoticeLabel%>:
                             <input id="notice" type="text" value="${cashatMasaryCompanies.warnSTR}" readonly style="color: red; font-size: medium;">
                              </p>    
                              </c:when>
                             </c:choose>
                            ...
                            <tr>
                                <td colspan="2">
                                <input type="submit" name="btnSubmit" tabindex="4" value="<%=CashatMasaryProperties.Param_CashatMasary_DoneLabel%>"  onclick="return formSubmit()" class="Btn"></td>
