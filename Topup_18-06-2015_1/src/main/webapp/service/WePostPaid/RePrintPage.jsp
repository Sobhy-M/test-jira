    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">${receipt.transaction_date}</td><td style = "text-align: right;padding-right:25px;width:50%;">تاريخ وتوقيت العملية</td> </tr><tr>');
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">${receipt.ledgerTrxId}</td><td style = "text-align: right;padding-right:25px;width:50%;">الرقم المرجعى</td> </tr><tr>');
                printwindow.document.write('<tr><th colspan="2">-------------------------------------------------------- </th></tr>');
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">${receipt.phone}</td><td style="text-align: right;padding-right:25px;width: 50%;">رقم العميل</td></tr>');
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">${receipt.totalDueAmount}</td><td style="text-align: right;padding-right:25px;width: 50%;">قيمة الفاتورة</td></tr>');
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">${receipt.fees}</td><td style="text-align: right;padding-right:25px;width: 50%;">تكلفه الخدمه</td></tr>');
                printwindow.document.write('<tr><td style="padding-left:15px;width: 50%;">${receipt.toBePaid}</td><td style="text-align: right;padding-right:25px;width: 50%;">اجمالى المبلغ المدفوع</td> </tr>');
                printwindow.document.write('<tr><th colspan="2">-------------------------------------------------------- </th></tr>');
        ...
        <div class="content_body">
            ...
            <table  style="width: 40%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="${receipt.transaction_date}"  readonly style="background-color: #EDEDED;" >
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" value="${receipt.globalTrxID}" readonly style="background-color: #EDEDED;" >
                    </td>                           
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="${receipt.totalDueAmount}" readonly style="background-color: #EDEDED;" >
                    </td>
                </tr>
                <tr>
                    <td>
