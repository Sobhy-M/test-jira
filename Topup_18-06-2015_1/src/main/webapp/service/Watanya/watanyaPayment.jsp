<%-- 
    Document   : Donation
    Created on : 05/06/2017, 01:12:20 م
    Author     : Mustafa
--%>
    ...
    <head>
        ...
        <script>
            function setDivPrint() {
                ...
                printwindow.document.write('<tr><th colspan="2">جمعية وطنية لتنمية وتطوير دور الأيتام </th></tr>');
    ...
    <body class="body">
        <div>
            ...
            <table cellspacing="10" cellpadding="4" style="font-size: 20px; font-weight: 900; width: auto" > 
                <tr>
                    <td colspan="2" style="text-align: center">جمعية وطنية لتنمية وتطوير دور الأيتام</td> 
                </tr>
                <tr>
                    <td>حاله العملية</td>
                ...
                <tr><td style="width: 50% ; padding-right: 30px;text-align: right;">القيمة </td><td style="padding-left: 10px;"><%= request.getParameter("Amount")%></td></tr>
