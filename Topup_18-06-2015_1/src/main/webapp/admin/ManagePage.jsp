...
<html>
    ...
    <BODY class="body">
        ...
        <form name="Manage agent" action="<%=CONFIG.APP_ROOT%>admin" method="POST" >
        <input type="hidden" name="action" value="<%=CONFIG.ACTION_MANAGE_ADMIN%>" />
        <div class="content_body"><br><br>
            <table >
                <tr>
                    <th scope="col"><%=CONFIG.getName(session)%></th>
                    <td><%=agent.getName(null)%></td>
                    <th rowspan="10"><input type="submit" name="btnSubmit" tabindex="6"
                ...
                <tr>
                    ...
                    <td><input type="password" class="text"  name="<%=CONFIG.PARAM_PASSWORD%>" tabindex="1" value=""/></td>
                </tr>
                <tr>
