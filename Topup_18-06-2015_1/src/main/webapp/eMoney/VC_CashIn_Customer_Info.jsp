...
<html>
    <head>
        ...
        <title><%=CONFIG.getVodafone_Cash(session)%>-<%=CONFIG.getVC_CashIn(session)%>-<%=CONFIG.getCustomer_Info(session)%></title>
        ...
        <div id="content">
            <center>
                ...
                <fieldset style="width: 28%; direction: rtl;" align="right">  
                    <legend align="right" ><font size="5"><%=CONFIG.getCustomer_Info(session)%>&nbsp; </font><img src="img/CashIn.ico"  width="20" height="20" style="background: url('CashIn.ico') no-repeat scroll 100% 50% transparent;"> </legend> 
                    <input type="hidden" name="action" value="<%=CONFIG.CHECKIN_Customer_Info%>" />
