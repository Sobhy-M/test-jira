        ...
        <div class="main_body" align="center">
            <div class="top_header" align="center" style="background:url(img/header_bg.png) no-repeat"><!-- Header div-->
                ...
                <div class="content_body"><br><br>
                    <br><br>
                    <form action="<%=CONFIG.APP_ROOT%>Web" method=post  name="agent_form" id="saveform">
                        <input type="hidden" name="action" value="<%= CONFIG.ACTION_SERVICE_OPERATIONS%>">
                        <table >
                            <th  scope="row">
                                <input type="submit" value="Manage Service Account" name="<%=CONFIG.PARAM_AGENT_BTN%>" />
                            </th>
                            <th  scope="row">
                                <input type="submit" value="View Transactions" name="<%=CONFIG.PARAM_AGENT_BTN%>" />
                            </th>
                            <th  scope="row">
                                <input type="submit" value="Add Bills" name="<%=CONFIG.PARAM_AGENT_BTN%>" />
                            </th>
