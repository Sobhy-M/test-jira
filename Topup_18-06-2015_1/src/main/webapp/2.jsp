...
<html>
    <head>
        ...
        <style type="text/css">
            .ui-notify { width:350px; position:fixed; bottom:5px; right:10px; }
            ...
            .ui-notify-close { color:#797268; text-decoration:underline }
            .ui-notify-click { cursor:pointer }
            .ui-notify-cross { margin-top:-4px; float:right; cursor:pointer; text-decoration:none; font-size:14px; font-weight:bold; text-shadow:0 1px 1px #fff; padding:2px }
            .ui-notify-cross:hover { color:#ffffab }
            .ui-notify-cross:active { position:relative; top:1px }</style>
            <%} else {%>
        <style type="text/css">
            .ui-notify { width:350px; position:fixed; bottom:5px; left:10px; }
            .ui-notify-message { padding:10px; margin-bottom:15px; -moz-border-radius:8px; -webkit-border-radius:8px; border-radius:8px }
            .ui-notify-message h1 { font-size:14px; margin:0; padding:0 }
            .ui-notify-message p { margin:3px 0; padding:0; line-height:18px }
            .ui-notify-message:last-child { margin-bottom:0 }
