 ...
 * @author user
 */
public class KafrElShiekhWaterInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            KafrElShiekhWaterInquiryResponse kafrElShiekhWaterInquiryResponse = kafrElShiekhWaterClient.billsInquiry(request.getParameter("subscriptionNumber"), request.getParameter("mobileNumber"), lang, session.getAttribute("Token").toString());
            ...
            nextJSP = rb.getString("Page_KafrElShiekhWater_Info");
