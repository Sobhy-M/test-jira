 ...
 * @author user
 */
public class VodafoneTopupDsl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            VodafoneDslDenomination[] VodafoneTopupDslDenominations = VodafoneTopupDslClient.getDenominations(lang,
                    session.getAttribute("Token").toString());

            session.setAttribute("vodafoneTopupDslDenomenations", VodafoneTopupDslDenominations);

            nextJSP = VodafoneDSLProperties.Page_VodafoneDsl_Home;
