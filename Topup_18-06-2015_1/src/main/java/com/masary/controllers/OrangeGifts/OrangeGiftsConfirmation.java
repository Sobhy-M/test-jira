 ...
 * @author user
 */
public class OrangeGiftsConfirmation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OrangeGiftsInquiryRepresentation inquiryRepresentation = orangeGiftsClient.verfiVoucher(request.getParameter("code"), lang, session.getAttribute("Token").toString());

            if (inquiryRepresentation != null) {
                request.setAttribute("inquiryRepresentation", inquiryRepresentation);
                nextJSP = rb.getString("Page_OrangeGifts_Confirmation");
            }
