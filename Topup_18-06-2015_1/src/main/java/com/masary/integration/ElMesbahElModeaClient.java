 ...
 */
public class ElMesbahElModeaClient extends CommonCalls {
    ...
    public Representation payment(ElMesbahElModeaPaymentRequest paymentRequest, String lang, String token) throws Exception {
        this.logger = initLogger();

        String paymentUrl = loadUrlProperty("ElMesbahElModea.payment.url");
        ...
        try {
            ...
            String urlParameters = object2Json(paymentRequest, ElMesbahElModeaPaymentRequest.class);
            logger.info(" payment url parameters :- " + urlParameters);
    ...
    public Representation reprint(long ledgerTrxId, String lang, String token) throws Exception {
        ...
        String reprintUrl = loadUrlProperty("ElMesbahElModea.reprint.url");
    ...
    public Governorates governorates(String lang, String token) throws Exception {
        this.logger = initLogger();

        String reprintUrl = loadUrlProperty("ElMesbahElModea.governorates.url");
        ...
        try {
            ...
            switch (getStatusCode(reprintResponseHttp)) {
                case 200:
                    return json2Object(reprintResponseJson, Governorates.class);
                default:
                    logger.info("Failed to get denominations");
                    StandardHttpJsonResponseDTO standardHttpJsonResponseDTO = json2Object(reprintResponseJson, StandardHttpJsonResponseDTO.class);
                    String errorMessage = getErrorMessage(lang, standardHttpJsonResponseDTO.getMessage());
    ...
    private String getErrorMessage(String lang, String message) {
        String errorMessage = "";
        if (message.equals("55001")) {
            errorMessage = lang.equals("ar") ? rb.getString("MESSAGE_Donation_55001") : rb.getString("MESSAGE_Donation_55001");
            ...
            errorMessage = lang.equals("ar") ? rb.getString("MESSAGE_DonationAr") : rb.getString("MESSAGE_DonationEn");
        }
