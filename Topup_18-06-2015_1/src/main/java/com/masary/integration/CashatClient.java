...
public class CashatClient extends CommonCalls {
	...
	public CashatInquiryResponse cashatInquiry(CashatInquiryRequest cashatInquiryRequest, String lang, String token)
		...
		String cashatUrl = loadUrlProperty("CashatMasary.inquery.url");
	...
	public CashatPaymentResponse cashatPayment(CashatPaymentRequest cashatPaymentRequest, String lang, String token)
		...
		String cashatUrl = loadUrlProperty("CashatMasary.payment.url");
		this.logger = initLogger();
		try {
			this.httpclient = initHttpClient();
	...
	public CashatCompniesDTO getCompanies(String lang, String token) throws Exception {
		...
		String cashatCompaniesurl = loadUrlProperty("CashatMasary.company.url");
		this.logger = initLogger();
		try {
	...
	public CashatPaymentResponse cashatReprint(String ledgerTrxId, String lang, String token, String ip)
		...
		this.logger = initLogger();
		String rePrintUrl = loadUrlProperty("CashatMasary.reprint.url");
	...
	protected String getErrorMessage(String lang, String message) {
		...
		if (message.equals("44401001")) {
			errorMessage = (lang.equals("ar") ? CashatMasaryProperties.errorCashatNotFoundAr : CashatMasaryProperties.errorCashatNotFoundEn);
		}
		else if (message.equals("44401002")) {
			errorMessage = (lang.equals("ar") ? CashatMasaryProperties.errorCashatRepNotFoundAr : CashatMasaryProperties.errorCashatRepNotFoundEn);
		}
		else if (message.equals("44401003")) {
			errorMessage = (lang.equals("ar") ? CashatMasaryProperties.errorCashatRepNotFoundAr : CashatMasaryProperties.errorCashatRepNotFoundEn2);
		}
		else if (message.equals("44401004")) {
			errorMessage = (lang.equals("ar") ? CashatMasaryProperties.errorCashatRepNotFoundAr : CashatMasaryProperties.errorCashatRepNotFoundEn);
		}
		else if (message.equals("44401005")) {
			errorMessage = (lang.equals("ar") ? CashatMasaryProperties.errorCashatCompanyNotFoundAr : CashatMasaryProperties.errorCashatNotFoundEn);
		}
		else if (message.equals("10")) {
			errorMessage = (lang.equals("ar") ? CashatMasaryProperties.errorCashatBadParameterAr : CashatMasaryProperties.errorCashatBadParameterEn);
		}
