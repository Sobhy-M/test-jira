 ...
 * @author Hammad
 */
public class VodafoneHttpManager extends BaseManger {

	private static VodafoneHttpManager instance = null;
	...
	private VodafoneHttpManager() {
	}
	//

	public static VodafoneHttpManager getInstance() {
		if (instance == null) {
			instance = new VodafoneHttpManager();
		}
		return instance;
	}
	...
	synchronized public TransactionInfoDTO transferCustomerTopUp(String custID, String msisdn, String amount,
		...
		logger.info("Vodafone Topup " + msisdn + " amount " + amount + " from " + custID);
		...
		try {
			...
			sqlStatement.setInt(5, 10); // serviceID_in
			...
			// throw new Exception(lang.equals("ar") ? CONFIG.transactionErrorar :
