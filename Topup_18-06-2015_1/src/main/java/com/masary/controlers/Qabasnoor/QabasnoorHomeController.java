 ...
 */
package com.masary.controlers.Qabasnoor;
 ...
 * @author user
 */
public class QabasnoorHomeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            nextJSP = CONFIG.QabasnoorHomePage;
            ...
            if (request.getParameter(CONFIG.OPERATION_ID).equals("114") || request.getParameter(CONFIG.OPERATION_ID).equals("121") || request.getParameter(CONFIG.OPERATION_ID).equals("122") || request.getParameter(CONFIG.OPERATION_ID).equals("123")) {
