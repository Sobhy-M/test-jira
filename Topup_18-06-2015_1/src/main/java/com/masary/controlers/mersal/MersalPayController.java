 ...
 * @author hammad
 */
public class MersalPayController extends HttpServlet {
...
//            session.setAttribute("BTC", bill_Type);
            nextJSP = CONFIG.ACTION_MERSAL_PAY;
        } else {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (CONFIG.ACTION_MERSAL_PAY.equals(action) && DbNextJSP.equals(action)) {
                nextJSP = CONFIG.MersalPayPage;
            }
        else
        {
            nextJSP = CONFIG.PAGE_ERRPR;
