 ...
 */
public class SonaaElkherConfirmationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CommissionTransaction commissionTransaction = sonaaElkherClient.ratePlanCommissions("514", request.getParameter("amount").toString(), lang, session.getAttribute("Token").toString());
     ...
     request.setAttribute("donationTypeId", donationTypeId);
                nextJSP = rb.getString("Page_SonaaElkher_Receipt");
            } else {
