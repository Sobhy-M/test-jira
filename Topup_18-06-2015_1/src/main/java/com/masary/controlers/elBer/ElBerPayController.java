 ...
 * @author hammad
 */
public class ElBerPayController extends HttpServlet {
...
//            session.setAttribute("BTC", bill_Type);
            nextJSP = CONFIG.ACTION_ELBER_PAY;
        } else {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (CONFIG.ACTION_ELBER_PAY.equals(action) && DbNextJSP.equals(action)) {
                nextJSP = CONFIG.ElBerPayPage;
            }
        else
        {
            nextJSP = CONFIG.PAGE_ERRPR;
