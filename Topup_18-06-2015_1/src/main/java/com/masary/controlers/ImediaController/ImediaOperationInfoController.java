 ...
 * @author Abdelsabor
 */
public class ImediaOperationInfoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bill_Response.getSTATUS_CODE() == 200) {
                request.setAttribute("ImediaBillValue", bill_Response.getAMOUNT());
                ...
                nextJSP = CONFIG.ImediaOperationInfoPage;
            } else {
