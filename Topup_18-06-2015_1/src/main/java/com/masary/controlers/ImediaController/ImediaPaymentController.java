 ...
 */
package com.masary.controlers.ImediaController;
 ...
 * @author Abdelsabor
 */
public class ImediaPaymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String fees = request.getParameter("ImediaServiceCost");
            String billing_account = request.getParameter("OperationID");
            
            
            Bill_Request bill_Request = new Bill_Request();
            bill_Request.setCUSTOMER_ID(customer_id);
            bill_Request.setAMOUNT(Double.parseDouble(request.getParameter("ImediaBillValue")));
            ...
            if (bill_Response.getSTATUS_CODE() == 200 || bill_Response.getSTATUS_CODE() == 201 || bill_Response.getSTATUS_CODE() == 202) {
                ...
                nextJSP = CONFIG.ImediaPaymentPage;
            } else {
                nextJSP = CONFIG.ImediaInqueryPage;
