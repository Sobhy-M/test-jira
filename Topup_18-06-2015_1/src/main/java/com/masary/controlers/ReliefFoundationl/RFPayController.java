 ...
 * @author Abdelsabor
 */
public class RFPayController extends HttpServlet {
    ...
    private String DB(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        ...
        if (agentPaymentRespponseDto.getSTATUS_CODE().equals("200") || agentPaymentRespponseDto.getSTATUS_CODE().equals("202")) {
            ...
            nextJSP = CONFIG.ReliefFoundationlPaymentPage;
        } else {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validateAmount == false) {
                session.setAttribute("ErrorMessage","الحد الأدنى للتبرع جنيها واحد بدون كسور");
                throw new Exception("الحد الأدنى للتبرع جنيها واحد بدون كسور");
