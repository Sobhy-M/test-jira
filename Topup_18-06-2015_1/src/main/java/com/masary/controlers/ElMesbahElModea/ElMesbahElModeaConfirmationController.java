 ...
 */
public class ElMesbahElModeaConfirmationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String governorateId = request.getParameter("governorateId");
            CommissionTransaction commissionTransaction = elMesbahElModeaClient.ratePlanCommissions("55", request.getParameter("amount").toString(), lang, session.getAttribute("Token").toString());
            ...
            if (representation != null) {
                ...
                request.setAttribute("governorateId", governorateId);
                nextJSP = rb.getString("Page_ElMesbahElModea_Receipt");
            } else {
