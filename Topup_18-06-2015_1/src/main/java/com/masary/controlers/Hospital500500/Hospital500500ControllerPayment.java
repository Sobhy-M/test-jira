 ...
 */
public class Hospital500500ControllerPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Representation representation = hospital500500Client.payment(paymentRequest, lang, session.getAttribute("Token").toString());
