 ...
 * @author Abdelsabor
 */
public class WKPayController extends HttpServlet {
    ...
    private String DB(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        ...
        if (agentPaymentRespponseDto.getSTATUS_CODE().equals("200")) {
            ...
            nextJSP = CONFIG.WasletKhierPaymentPage;
        } else {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validateAmount == false) {
                session.setAttribute("ErrorMessage","الحد الادنى للتبرع 10 جنيهات و الاقصى 5000 بدون كسور");
                nextJSP = CONFIG.PAGE_ERRPR;
            } else {
