 ...
 */
package com.masary.controlers.MostafaMahmoud;
 ...
 * @author user
 */
public class MostafaMahmoudPayController extends HttpServlet {
...
//        agentPaymentRequestDTO.setOPERATION_ID(Integer.parseInt(request.getParameter("OperationID")));
        ...
        if (agentPaymentRespponseDto.getSTATUS_CODE().equals("200") || agentPaymentRespponseDto.getSTATUS_CODE().equals("202")) {
            ...
            nextJSP = CONFIG.MostafaMahmoudPaymentPage;
        } else {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validateAmount == false) {
                session.setAttribute("ErrorMessage", "الحد الادنى للتبرع هو 5 جنيهات بدون كسور");
                nextJSP = CONFIG.PAGE_ERRPR;
            } else {
