package com.masary.controlers.elFager;
 ...
 * @author AYA
 */
public class ElFagerPaymentController extends HttpServlet {
        ...
        try {
            ...
            if (action.equals(CONFIG.ACTIONElFagerPayment)) {
                ...
                if (bill_Response.getSTATUS_CODE() == 200 || bill_Response.getSTATUS_CODE() == 201 || bill_Response.getSTATUS_CODE() == 202) {
                    ...
                    nextJSP = CONFIG.PAGEElFagerPAYMENTCONFIRMATION;
                } else {
                    nextJSP = CONFIG.PAGEElFagerINQUIRY;
