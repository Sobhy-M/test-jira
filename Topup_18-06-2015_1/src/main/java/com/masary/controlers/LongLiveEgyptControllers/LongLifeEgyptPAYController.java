 ...
 * @author Masary
 */
public class LongLifeEgyptPAYController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (CONFIG.ACTION_LONG_LIFE_EGYPT_PAY.equals(action) && DbNextJSP.equals(action)) {
                nextJSP = CONFIG.LongLifeEgyptPAYPage;
            }
        else
        {
            nextJSP = CONFIG.PAGE_ERRPR;
