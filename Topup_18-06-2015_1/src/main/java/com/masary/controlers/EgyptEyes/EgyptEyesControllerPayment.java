 ...
 */
public class EgyptEyesControllerPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Representation representation = egyptEyesClient.payment(paymentRequest, lang, session.getAttribute("Token").toString());
            java.util.Date dateValue = new java.util.Date(representation.getInsertDate());
        //    representation.setPaymantAmount(Long.valueOf(request.getParameter("amount")));
