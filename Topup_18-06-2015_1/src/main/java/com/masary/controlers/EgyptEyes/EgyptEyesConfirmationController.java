 ...
 */
package com.masary.controlers.EgyptEyes;
 ...
 */
public class EgyptEyesConfirmationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CommissionTransaction commissionTransaction = egyptEyesClient.ratePlanCommissions("512", request.getParameter("amount").toString(), lang, session.getAttribute("Token").toString());
            ...
            if (representation != null) {
                ...
                nextJSP = rb.getString("Page_egyptEyes_Receipt");
            } else {
